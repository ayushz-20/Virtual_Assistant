...
# #main loop monitor for image generation requests
# while True:
...
def generate_images_and_open(prompt: str):
    asyncio.run(generate_images(prompt))
    open_images(prompt)
...
while True:
    try:
        ...
        if data:
            ...
            if status == "True":
                print("Generating Images...")
                generate_images_and_open(prompt=prompt)
        ...
        print("Invalid format in ImageGeneration.data. Expected format: 'Prompt,Status'")
